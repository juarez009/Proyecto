        ...
        <main class="col ps-md-2 pt-2">
          ...
          <div className="content-fluid d-flex flex-column align-items-center">
            ...
            <div class="row text-center">
              <div class="col-md">
                <button className="btn btn-light buttons-actions" id="btnSub" onClick={props.conectarWallet}><i class="bi bi-link-45deg"></i></button>
                <label>Desconectar Wallet</label>
              </div>
              <div class="col-md">
                <button class="btn btn-light buttons-actions" >
